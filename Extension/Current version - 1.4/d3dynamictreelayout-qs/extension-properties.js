			...
			treeLayout:{
				...
				items: {
					...
					leafStrokeWidth: {
						...
						label: "Double Click Expand/Collapse",
						type: "boolean",
						component: "switch",
						options: [
							{ value: true, label: "Activated" },
						...
						ref: "properties.treeLayout.rectangle.selectable",
						label: "Add 'Selectable' Icon",
						type: "boolean",
						component: "switch",
						options: [
							{ value: true, label: "Activated" },
						...
						show: function( data ){ return data.properties.treeLayout.typeOfLeaf=="Rectangle"; },
						defaultValue: true
					},rectangleMeasureSetRenderType: {
						ref: "properties.treeLayout.rectangle.measureSetRenderType",
						label: "Measure Rendering Type",
						type: "string",
						component: "dropdown",
						options: [{
									value: "measure_text",
									...
									value: "measure_mouse_hover",
									label: "HTML: Mouse Hover"
								},{
									value: "measure_html",
									label: "HTML: Inside Rectangle"
								}],
						show: function( data ){ return data.properties.treeLayout.typeOfLeaf=="Rectangle"; },
						defaultValue: "measure_text"
					},//treeLayout.rectangle.measureSetRenderType
					rectangleFontSize: {
						...
						defaultValue: 15,
						expression: "",
						show: function( data ){ return data.properties.treeLayout.typeOfLeaf=="Rectangle" && data.properties.treeLayout.rectangle.measureSetRenderType!="measure_html"; }
					},rectangleFontColor: {
						...
						ref: "properties.treeLayout.rectangle.width",
						...
						ref: "properties.treeLayout.rectangle.height",
