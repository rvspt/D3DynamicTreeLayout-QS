	...
	function update(source) {
		...
		if(treeProperties.treeLayout.typeOfLeaf=="Circle")
		{
			...
			nodeEnter.append("svg:circle")
				  .attr("r", 1e-6)
				  .style("stroke", treeProperties.treeLayout.leaf.strokeColor)
				  .style("stroke-width", treeProperties.treeLayout.leaf.strokeWidth)
				  .style("fill", function(d) { return d._children ? treeProperties.treeLayout.leaf.parentFillColor : treeProperties.treeLayout.leaf.childFillColor; })
